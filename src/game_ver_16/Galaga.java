...
public class Galaga extends JFrame {
	...
	public Galaga() {
		trackList.add(new Track("song_title.jpg", "snowtiger.jpg", "moon.jpg", "funky.mp3", "funky.mp3", "song_one"));
		trackList.add(new Track("song_title.jpg", "tiger.jpg", "moon.jpg", "onceagain.mp3", "onceagain.mp3", "song_two"));
		trackList.add(new Track("song_title.jpg", "eagle.jpg", "moon.jpg", "sunny.mp3", "sunny.mp3", "song_three"));
