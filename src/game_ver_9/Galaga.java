...
public class Galaga extends JFrame {
	...
	public Galaga() {
		...
		setLayout(null);
		introMusic.start();
		trackList.add(new Track("song_title.jpg","snowtiger.jpg","snowtiger.jpg","funky.mp3","funky.mp3"));
		trackList.add(new Track("song_title.jpg","tiger.jpg","tiger.jpg", "onceagain.mp3","onceagain.mp3"));
		trackList.add(new Track("song_title.jpg","eagle.jpg","eagle.jpg", "sunny.mp3","sunny.mp3"));
